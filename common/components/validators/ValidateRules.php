...
class ValidateRules
{
    ...
    public static function getSignUpRules(): array
    {
        ...
        return array_merge(
                static::getNameRules(),
                $rules,
                static::getPasswordRepeatRules(),
                static::createRequiredRules($signup->attributeLabels(), ['name', 'passwordRepeat']),
                static::createTrimRules($signup->attributes()));
    }
    ...
    public static function getUpdateProfileRules(): array
    {
        ...
        return array_merge(
                ...
                static::getPasswordRepeatRules(),
                static::createTrimRules($profileData->attributes())
                );
    }
