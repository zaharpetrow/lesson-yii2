...
<?php if (Yii::$app->session->has('testSession')): ?>
    <?php if (Yii::$app->session->hasFlash('accessTest')): ?>
        <div class="alert alert-success">
            <?= Yii::$app->session->getFlash('accessTest') ?>
        </div>
    <?php endif; ?>
    Session: <?= Yii::$app->session->get('testSession') ?>
<?php else: ?>
    <?php $form = ActiveForm::begin(); ?>

    <?= $form->field($model, 'sessionField') ?>
